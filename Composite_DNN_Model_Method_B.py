...
#------------------------------------------------------------------------------
  ...
  # output_sc = np.zeros([5500,5500], dtype="f")  
  # output_sc = output_sc.astype(np.int8)
  
  # output_sc_2 = np.zeros([5500,5500], dtype="f")  
  # output_sc_2 = output_sc.astype(np.int8)  
...
#------------------------------------------------------------------------------
  # # Seize the output variable 2
  # output_sc_2 = gk2a_sc  # GK-2A SCSI Data

  # gk2a_sc_dnn_sc_ind = (dnn_sc == 7)  & (gk2a_sc != 1)   ; output_sc_2[gk2a_sc_dnn_sc_ind] = 1  # Snow (DNN)
  # gk2a_sc_dnn_cld_ind = (dnn_sc == 8) & (gk2a_sc != 1)   ; output_sc_2[gk2a_sc_dnn_cld_ind] = 3 # Cloud(DNN)

#------------------------------------------------------------------------------  

    
  # # Write the final output_2
  # with open(opath+"gk2a.sc_dnn.sc_all.pixel_1_"+date_nm+".bin", "wb") as f:
  #   f.write(output_sc_2)    
